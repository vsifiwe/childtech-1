...
function Login() {
    ...
    let handleSubmit = (event) => {
        ...
        axios.post('https://childtech.herokuapp.com/api/token/', {"username":username, "password":password})
        .then(response => {
                    ...
                    <div class="min-h-screen flex flex-row items-center justify-center bg-gray-100">                        
                        <div class="flex flex-col -pt-8 bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-6 w-50 max-w-md ">
                            ...
                            <div class="flex justify-center items-center mt-6">
                                <Link to ='/signup' target="_blank" class="inline-flex items-center text-gray-700 font-medium text-xs text-center">
                                    <span class="ml-2">You don't have an account?
                                        <Link to ='/signup' class="text-xs ml-2 text-blue-500 font-semibold">Register now</Link>
                                    </span>
                                </Link>
                            </div>
                        </div>
