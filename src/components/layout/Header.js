                    ...
                    <div className="lg:flex flex-grow items-center" id="example-navbar-warning">
                        <ul className="flex flex-col lg:flex-row list-none ml-auto px-8">
                            <li className="nav-item">
                                <Link to='/' className="py-2 flex items-center  text-lg uppercase leading-snug text-blue-600 hover:opacity-75">
                                    Home
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link to='/about' className="px-4 py-2 flex items-center  text-lg uppercase leading-snug text-blue-600 hover:opacity-75">
                                    About
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link to='/services' className="flex -ml-2 items-center text-lg uppercase leading-snug text-white hover:opacity-75">
                            ...
                            <li className="nav-item">
                                <Link to='/events' className="flex items-center text-lg uppercase leading-snug text-white hover:opacity-75">
                            ...
                            <button className="ring-2 ring-blue-800 text-lg mr-6 ml-8 hover:bg-gray-300 text-blue-800  px-8 mr-4 rounded-md">
                                <Link to='/login'>Login </Link>
                            </button>
                            <button className="ring-2 text-lg mr-6 bg-blue-500 hover:bg-gray-300 text-white px-8 mr-4 rounded-md">
