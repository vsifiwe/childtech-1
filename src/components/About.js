				...
				>
					...
					<div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12 pt-96 transform transition cursor-none hover:-translate-y-12 ">
						<div class="bg-blue-400 w-full justify-center shadow rounded p-8 sm:p-12 -mt-72">
							<h1 className="text-center text-white font-semibold text-3xl p-8">
								About ChildTech
							</h1>
							<ul>
								<li class="flex items-center space-x-2">
									...
									<span className="p-2 text-lg text-white">
										ChildTech is a STEM program that is going to teach children
										about technology.
									</span>
								</li>
								<li class="flex items-center space-x-2">
									...
									<span className="p-2 text-lg text-white">
										This program will be having children from 7 years to 14
										years, through ChildTech, children will be able to improve
										their computation skills, problem solving skills, sharpen
										their minds and increase their level of observation thus
										being creative.
									</span>
								</li>
								<li class="flex items-center space-x-2">
									...
									<span className="p-2 text-lg text-white">
										ChildTech will be having several courses including the
										coding part, the practical science part and the engineering
										part, through different programs
									</span>
								</li>
							</ul>
