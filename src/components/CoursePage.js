...
function CoursePage() {
    ...
    useEffect(() => {
        ...
        axios.get('http://childtech.herokuapp.com/api/courses/')
        .then(response =>{ 
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            {  
                                ...
                                <div class="object-center object-cover h-auto w-full">
                                    {/* <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLjk85JoJ8wHLR3yvqdAlObPs4emtwYfph" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> */}
                                    {/* <img src={course.img}/> */}
